...
export function getCodePulseHome(): string {
...
export function readDaemonToken(homeDir = getCodePulseHome()): string | undefined {
...
export function readDaemonPort(homeDir = getCodePulseHome()): number {
...
export function readDaemonHost(): string {
